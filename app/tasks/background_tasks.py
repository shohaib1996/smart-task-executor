"""
Background tasks using FastAPI BackgroundTasks instead of Celery.
This allows running async tasks without requiring Redis/Celery infrastructure.
"""
...
async def start_workflow_task(workflow_id: str, user_id: str):
...
async def execute_approved_actions(workflow_id: str):
...
async def process_user_selection(workflow_id: str, option_id: str, user_id: str):
